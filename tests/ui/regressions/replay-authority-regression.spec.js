...
function assertReplaySnapshotContract(snapshot, ticker){
  ...
  expect(snapshot.canonicalContract, `${ticker} replay snapshot must include canonical contract authority.`).toBeTruthy();
  expect(snapshot.renderModels, `${ticker} replay snapshot must include canonical render models.`).toBeTruthy();
...
function summarizeStageMutation(preTrackState, postTrackState, context = {}){
  ...
  const fields = [
    ...
    ['trackCanonicalVerdict', preTrackState && preTrackState.track && preTrackState.track.simplifiedState && preTrackState.track.simplifiedState.canonicalVerdict, postTrackState && postTrackState.track && postTrackState.track.simplifiedState && postTrackState.track.simplifiedState.canonicalVerdict, 'buildTrackRenderModel() / shared presentation cache'],
    ['trackPriceabilityState', preTrackState && preTrackState.track && preTrackState.track.simplifiedState && preTrackState.track.simplifiedState.priceabilityState, postTrackState && postTrackState.track && postTrackState.track.simplifiedState && postTrackState.track.simplifiedState.priceabilityState, 'buildTrackRenderModel() / shared presentation cache'],
