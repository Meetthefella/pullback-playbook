const validPlan = (entry, stop, target) => ({
  status:'valid', entry, stop, target, tradeability:'tradable',
  rewardRisk:{rrRatio:(target - entry) / (entry - stop)},
  riskFit:{risk_status:'fits_risk', position_size:10},
...
module.exports = [
  fixture('hwm_confirmed_control', 'HWM', {structureState:'strong', trendState:'intact', pullbackZone:'near_20ma', stabilisationState:'clear', bounceState:'confirmed', volumeState:'supportive', setupLocationState:'at_support', priceabilityState:'priceable'}, validPlan(100, 97, 107), {finalVerdict:'Entry', structuralState:'entry', actionStateKey:'ready_to_act', planStatusKey:'valid', tradeabilityVerdict:'Entry', blockerReason:'', reasonSummary:'Confirmed control.', baseVerdict:'entry'}, {price:101, ma20:99, ma50:95, ma200:90}, {phase:'responding_from_support', supportInteraction:'holding', supportCurrentlyActive:true, buyerResponsePresent:true, buyerControlState:'confirmed'}),
  fixture('amzn_emerging_buyer_control', 'AMZN', {structureState:'intact', trendState:'strong', pullbackZone:'near_20ma', stabilisationState:'early', bounceState:'attempt', volumeState:'normal', setupLocationState:'at_support', priceabilityState:'provisional'}, validPlan(180, 175, 191), {finalVerdict:'Watch', structuralState:'developing', actionStateKey:'wait_for_confirmation', planStatusKey:'valid', tradeabilityVerdict:'Watch', blockerReason:'Buyer control is emerging but not confirmed.', reasonSummary:'Wait for confirmation.', baseVerdict:'watch'}, {price:179, ma20:178, ma50:170, ma200:155}, {phase:'at_support', supportInteraction:'holding', supportCurrentlyActive:true, buyerResponsePresent:true, buyerControlState:'emerging'}),
  fixture('kdp_confirmed_without_follow_through', 'KDP', {structureState:'intact', trendState:'strong', pullbackZone:'near_50ma', stabilisationState:'clear', bounceState:'confirmed', volumeState:'normal', setupLocationState:'at_support', priceabilityState:'priceable'}, validPlan(34, 32.5, 38), {finalVerdict:'Near Entry', structuralState:'near_entry', actionStateKey:'wait_for_confirmation', planStatusKey:'valid', tradeabilityVerdict:'Near Entry', blockerReason:'Follow-through is still required.', reasonSummary:'Confirmed response without follow-through.', baseVerdict:'near_entry'}, {price:33.8, ma20:34.2, ma50:33.5, ma200:30}, {phase:'responding_from_support', supportInteraction:'holding', supportCurrentlyActive:true, buyerResponsePresent:true, buyerControlState:'confirmed'}),
