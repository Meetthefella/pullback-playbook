...
function watchlistLifecycleSnapshot(record){
  ...
  const primaryState = String(resolved.primaryState || emojiPresentation.primaryState || 'monitor').toLowerCase();
  ...
  if(technicalDead){
    ...
    status = 'inactive';
    nextExpiryAt = '';
    reason = resolved.reasonSummary || resolved.blockerReason || 'Invalid plan - needs re-entry setup.';
...
function scanCardSummaryForView(view){
  ...
  let primary = '';
  let secondary = '';
  const decision = scanDecisionLineForView(view);
  ...
  if(item.setup.marketCaution && !/weak market/i.test(decision)){
    secondary = 'Weak market';
  }else if(String(derived.bounceState || '').toLowerCase() === 'confirmed' && !/bounce|confirmation/i.test(decision)){
    secondary = 'Bounce confirmed';
  }else if(String(derived.bounceState || '').toLowerCase() === 'attempt' && !/bounce|confirmation/i.test(decision)){
    secondary = 'Bounce tentative';
  }else if(String(derived.bounceState || '').toLowerCase() === 'none' && !/bounce|confirmation/i.test(decision)){
    secondary = 'No bounce';
  }
  return {
    primary,
...
function scanDecisionLineForView(view){
  ...
  if(primaryState === 'near_entry') return 'Near trigger - monitor closely';
...
function resolveFinalStateContract(record, options = {}){
  ...
  if(hardStructureBroken){
    ...
    actionLabel = 'Structure damaged - wait for rebuild';
    ...
    actionLabel = 'Setup invalidated - avoid until rebuilt';
    actionShortLabel = actionLabel;
    actionTone = 'danger';
    nextPossibleState = 'None';
    addReason(blockerReason);
    ...
    actionLabel = 'Invalid plan - needs re-entry setup';
    actionShortLabel = actionLabel;
    actionTone = 'warning';
    ...
    actionLabel = 'Risk too wide for account size';
    actionShortLabel = actionLabel;
    actionTone = 'warning';
    nextPossibleState = '🧐 Monitor';
    addReason(blockerReason);
    ...
    actionLabel = 'Capital fit is too weak for this setup';
    actionShortLabel = actionLabel;
    actionTone = 'warning';
    nextPossibleState = '🧐 Monitor';
    addReason(blockerReason);
    ...
    actionLabel = 'Adjust target before considering entry';
    actionShortLabel = actionLabel;
    actionTone = 'warning';
    nextPossibleState = '🧐 Monitor';
    addReason(blockerReason);
    ...
    actionLabel = 'Adjust plan before considering entry';
    actionShortLabel = actionLabel;
    actionTone = 'warning';
    nextPossibleState = '🧐 Monitor';
    addReason(blockerReason);
    ...
    actionLabel = 'Wait for bounce confirmation';
    actionShortLabel = actionLabel;
    actionTone = 'warning';
    ...
    actionLabel = 'Monitor for stronger volume';
    actionShortLabel = actionLabel;
    ...
    actionLabel = 'Wait for better conditions';
    actionShortLabel = actionLabel;
    actionTone = 'warning';
    nextPossibleState = '🎯 Near Entry';
    addReason(blockerReason);
    ...
    actionLabel = 'Wait for tighter structure';
    actionShortLabel = actionLabel;
    actionTone = 'warning-soft';
    nextPossibleState = '🎯 Near Entry';
    addReason(blockerReason);
    ...
    actionLabel = 'Execute trade plan';
    actionShortLabel = actionLabel;
    actionTone = 'success';
    ...
    actionLabel = 'Prepare entry - near trigger';
    actionShortLabel = 'Prepare entry';
    actionTone = 'warning';
    nextPossibleState = '🚀 Entry';
  }
...
function contextualResultEmptyState(bucket){
  const market = String(state.marketStatus || '').trim() || 'Market status not set';
  if(bucket === 'tradeable_entry'){
    return `No entry-ready setups right now. Market regime: ${market}. Review the monitor bucket or rescan after the next clean pullback.`;
  }
...
function renderReviewWorkspace(options = {}){
  ...
  const reviewBadgeLabel = resolvedContract.badgeText;
  ...
  const nextActionText = resolvedContract.actionLabel;
